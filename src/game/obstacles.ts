// =====================================================================
// STARTUP RUN — 장애물 정의 + 패턴 풀 (v2.2: 크게 + 다양)
// 12종, 전부 사망 트리거.
// =====================================================================
...
export const OBSTACLE_DEFS: Record<ObstacleType, ObstacleDef> = {
  ...
  // ── 숙이기류 (offsetY로 서있는 플레이어 몸통 위치 — 숙여야 통과) ────────
  competitor: {
    type: 'competitor',
    action: 'duck',
    label: '경쟁',
...
export const OBSTACLE_PATTERNS: ObstaclePattern[] = [
  // 단일 (전 12종 골고루)
  { name: 'pass', sequence: ['investor_pass'] },
  { name: 'burnout', sequence: ['burnout'] },
  { name: 'rent', sequence: ['rent_due'] },
  { name: 'bug', sequence: ['product_bug'] },
  { name: 'competitor', sequence: ['competitor'] },
  { name: 'lawsuit', sequence: ['lawsuit'] },
  { name: 'tax', sequence: ['tax_audit'] },
  { name: 'aws', sequence: ['aws_bill'] },
